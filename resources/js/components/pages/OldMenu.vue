    ...
    <v-container>
        <v-card>
            <v-card-title>
                ...
                ></v-text-field>
                <!--<v-spacer></v-spacer>-->
                <v-btn icon :loading="loading" v-on:click.prevent="getProducts" class="ml-3">
                    <v-icon>cached</v-icon>
                </v-btn>
            </v-card-title>
            <v-data-table :headers="productHeaders" :items="products" :items-per-page="15" :loading="loading"
...
export default {
    data: () => ({
        productHeaders: [
            {text: "Photo", value: "photo_url", filterable: false, sortable: false},
